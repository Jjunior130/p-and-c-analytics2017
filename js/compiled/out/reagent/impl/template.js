...
var G__38787 = o;
(G__38787[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__38793 = jsprops;
(G__38793["defaultValue"] = value);

(G__38793["onChange"] = ((function (G__38793,v,value,on_change){
return (function (p1__38792_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38792_SHARP_);
});})(G__38793,v,value,on_change))
);
...
var vec__38796 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38796,(0),null);
var id = cljs.core.nth.call(null,vec__38796,(1),null);
var class$ = cljs.core.nth.call(null,vec__38796,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___38800 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___38800 == null)){
} else {
var key_38801 = temp__4661__auto___38800;
(jsprops["key"] = key_38801);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__38802 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__38802["name"] = c);
...
var len__28364__auto___38807 = arguments.length;
var i__28365__auto___38808 = (0);
while(true){
if((i__28365__auto___38808 < len__28364__auto___38807)){
args__28371__auto__.push((arguments[i__28365__auto___38808]));

var G__38809 = (i__28365__auto___38808 + (1));
i__28365__auto___38808 = G__38809;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38805){
var G__38806 = cljs.core.first.call(null,seq38805);
var seq38805__$1 = cljs.core.next.call(null,seq38805);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__38806,seq38805__$1);
});
...
break;
default:
var G__38812 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38812;
continue;
...
var n__28140__auto___38814 = a.length;
var i_38815 = (0);
while(true){
if((i_38815 < n__28140__auto___38814)){
(a[i_38815] = reagent.impl.template.as_element.call(null,(a[i_38815])));
...
var a = cljs.core.into_array.call(null,s);
var n__28140__auto___38817 = a.length;
var i_38818 = (0);
while(true){
if((i_38818 < n__28140__auto___38817)){
var val_38819 = (a[i_38818]);
if((cljs.core.vector_QMARK_.call(null,val_38819)) && ((reagent.impl.template.key_from_vec.call(null,val_38819) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38818] = reagent.impl.template.as_element.call(null,val_38819));

var G__38820 = (i_38818 + (1));
i_38818 = G__38820;
continue;
} else {
}
...
var ctx = ({});
var vec__38821 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__38821,(0),null);
var derefed = cljs.core.nth.call(null,vec__38821,(1),null);
...
var G__38824 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38824) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38824){
...
//# sourceMappingURL=template.js.map?rel=1514003840301
