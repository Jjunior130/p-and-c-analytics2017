...
var vec__46941_46944 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_46945 = cljs.core.nth.call(null,vec__46941_46944,(0),null);
var only_after_46946 = cljs.core.nth.call(null,vec__46941_46944,(1),null);
var db_changed_QMARK__46947 = (!((only_before_46945 == null))) || (!((only_after_46946 == null)));
if(db_changed_QMARK__46947){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_46945);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_46946);
...
var map__46948 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__46948__$1 = ((((!((map__46948 == null)))?((((map__46948.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46948.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46948):map__46948);
var db = cljs.core.get.call(null,map__46948__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__46948__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__46950 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__46950__$1 = ((((!((map__46950 == null)))?((((map__46950.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46950.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46950):map__46950);
var coeffects = map__46950__$1;
var event = cljs.core.get.call(null,map__46950__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__28364__auto___46953 = arguments.length;
var i__28365__auto___46954 = (0);
while(true){
if((i__28365__auto___46954 < len__28364__auto___46953)){
args__28371__auto__.push((arguments[i__28365__auto___46954]));

var G__46955 = (i__28365__auto___46954 + (1));
i__28365__auto___46954 = G__46955;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq46952){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq46952));
});
...
var args__28371__auto__ = [];
var len__28364__auto___46961 = arguments.length;
var i__28365__auto___46962 = (0);
while(true){
if((i__28365__auto___46962 < len__28364__auto___46961)){
args__28371__auto__.push((arguments[i__28365__auto___46962]));

var G__46963 = (i__28365__auto___46962 + (1));
i__28365__auto___46962 = G__46963;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__46956_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__46957_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__46957_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq46958){
var G__46959 = cljs.core.first.call(null,seq46958);
var seq46958__$1 = cljs.core.next.call(null,seq46958);
var G__46960 = cljs.core.first.call(null,seq46958__$1);
var seq46958__$2 = cljs.core.next.call(null,seq46958__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__46959,G__46960,seq46958__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1514349657073
