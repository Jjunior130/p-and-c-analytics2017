...
var o41463 = temp__4655__auto__;
var temp__4655__auto____$1 = (o41463["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o41464 = temp__4655__auto____$1;
return (o41464["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40607__auto__ = f;
return (o__40607__auto__["toString"]).call(o__40607__auto__);
} else {
return "";
}
}catch (e41465){var _ = e41465;
return "";
}});
...
try{var o__40607__auto___41467 = t;
(o__40607__auto___41467["cljs$lang$ctorPrWriter"]).call(o__40607__auto___41467,t,writer);
}catch (e41466){var __41468 = e41466;
}
...
var char_code = (function (){var o__40607__auto__ = (new String(char$));
return (o__40607__auto__["charCodeAt"]).call(o__40607__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40607__auto__ = String;
return (o__40607__auto__["fromCharCode"]).call(o__40607__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41469 = num_code;
switch (G__41469) {
case (1):
return (185);
...
var o__40607__auto__ = String;
return (o__40607__auto__["fromCharCode"]).call(o__40607__auto__,superscript_code);
});
/**
...
}catch (e41471){var _e__40614__auto__ = e41471;
return false;
}})())){
...
var vec__41472 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__41472,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o41475 = temp__4655__auto__;
var temp__4655__auto____$1 = (o41475["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o41476 = temp__4655__auto____$1;
return (o41476["nameToPath"]);
} else {
return null;
}
} else {
...
var len__28364__auto___41483 = arguments.length;
var i__28365__auto___41484 = (0);
while(true){
if((i__28365__auto___41484 < len__28364__auto___41483)){
args__28371__auto__.push((arguments[i__28365__auto___41484]));

var G__41485 = (i__28365__auto___41484 + (1));
i__28365__auto___41484 = G__41485;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41479){
var vec__41480 = p__41479;
var ns_detector = cljs.core.nth.call(null,vec__41480,(0),null);
...
var G__41486 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__41487 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__41486;
remaining_tokens = G__41487;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41477){
var G__41478 = cljs.core.first.call(null,seq41477);
var seq41477__$1 = cljs.core.next.call(null,seq41477);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__41478,seq41477__$1);
});
...
var vec__41491 = cljs.core.split_with.call(null,(function (p1__41490_SHARP_){
return cljs.core.not_EQ_.call(null,p1__41490_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__41491,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__41491,(1),null);
...
var vec__41494 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__41494,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__41494,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__41497 = cljs.core.rest.call(null,remaining_tokens);
var G__41498 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__41497;
name_tokens = G__41498;
continue;
} else {
...
var vec__41501 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__41501,(0),null);
var arity = cljs.core.nth.call(null,vec__41501,(1),null);
var vec__41504 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__41504,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__41504,(1),null);
var vec__41507 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__41507,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__41507,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__41507,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__41507,(3),null);
...
var vec__41513 = result;
var munged_ns = cljs.core.nth.call(null,vec__41513,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__41513,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__41513,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__41513,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__41513,(4),null);
var arity = cljs.core.nth.call(null,vec__41513,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__41517 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__41517,(0),null);
var args = cljs.core.nth.call(null,vec__41517,(1),null);
var vec__41520 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__41520,(0),null);
var name = cljs.core.nth.call(null,vec__41520,(1),null);
...
var G__41523 = (arity + (1));
var G__41524 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41525){
var vec__41526 = p__41525;
var arity = cljs.core.nth.call(null,vec__41526,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__41526,(1),null);
...
return cljs.core.get.call(null,arities,p1__41529_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__41530_SHARP_);
...
var args__28371__auto__ = [];
var len__28364__auto___41537 = arguments.length;
var i__28365__auto___41538 = (0);
while(true){
if((i__28365__auto___41538 < len__28364__auto___41537)){
args__28371__auto__.push((arguments[i__28365__auto___41538]));

var G__41539 = (i__28365__auto___41538 + (1));
i__28365__auto___41538 = G__41539;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41533){
var vec__41534 = p__41533;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__41534,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41531){
var G__41532 = cljs.core.first.call(null,seq41531);
var seq41531__$1 = cljs.core.next.call(null,seq41531);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__41532,seq41531__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__41542__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__41542__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__41542__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__41542__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41543 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__41543,(0),null);
var fn_name = cljs.core.nth.call(null,vec__41543,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__41543,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__41543,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__41543,(4),null);
var arity = cljs.core.nth.call(null,vec__41543,(5),null);
...
var o__40607__auto__ = f;
return (o__40607__auto__["getBasis"]).call(o__40607__auto__);
});
/**
...
}catch (e41547){var _e__40614__auto__ = e41547;
...
var G__41548 = (obj[cljs.core.first.call(null,path)]);
var G__41549 = cljs.core.rest.call(null,path);
obj = G__41548;
path = G__41549;
continue;
} else {
...
return (function (accum,p__41550){
var vec__41551 = p__41550;
var bit = cljs.core.nth.call(null,vec__41551,(0),null);
var protocol = cljs.core.nth.call(null,vec__41551,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41554){
var vec__41555 = p__41554;
var ns = cljs.core.nth.call(null,vec__41555,(0),null);
var name = cljs.core.nth.call(null,vec__41555,(1),null);
var selector = cljs.core.nth.call(null,vec__41555,(2),null);
...
return (function (p__41559){
var vec__41560 = p__41559;
var munged_name = cljs.core.nth.call(null,vec__41560,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__41560,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__41560,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__41558_SHARP_){
return (obj[cljs.core.first.call(null,p1__41558_SHARP_)]);
});})(name,sorted_matches,vec__41560,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1513978684636
