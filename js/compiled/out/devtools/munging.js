...
var o56642 = temp__4655__auto__;
var temp__4655__auto____$1 = (o56642["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o56643 = temp__4655__auto____$1;
return (o56643["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__38910__auto___56646 = t;
(o__38910__auto___56646["cljs$lang$ctorPrWriter"]).call(o__38910__auto___56646,t,writer);
}catch (e56645){var __56647 = e56645;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__56648 = num_code;
switch (G__56648) {
case (1):
return (185);
...
}catch (e56650){var _e__38917__auto__ = e56650;
return false;
}})())){
...
var vec__56651 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__56651,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o56654 = temp__4655__auto__;
var temp__4655__auto____$1 = (o56654["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o56655 = temp__4655__auto____$1;
return (o56655["nameToPath"]);
} else {
return null;
}
} else {
...
var len__28364__auto___56662 = arguments.length;
var i__28365__auto___56663 = (0);
while(true){
if((i__28365__auto___56663 < len__28364__auto___56662)){
args__28371__auto__.push((arguments[i__28365__auto___56663]));

var G__56664 = (i__28365__auto___56663 + (1));
i__28365__auto___56663 = G__56664;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__56658){
var vec__56659 = p__56658;
var ns_detector = cljs.core.nth.call(null,vec__56659,(0),null);
...
var G__56665 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__56666 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__56665;
remaining_tokens = G__56666;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq56656){
var G__56657 = cljs.core.first.call(null,seq56656);
var seq56656__$1 = cljs.core.next.call(null,seq56656);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__56657,seq56656__$1);
});
...
var vec__56670 = cljs.core.split_with.call(null,(function (p1__56669_SHARP_){
return cljs.core.not_EQ_.call(null,p1__56669_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__56670,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__56670,(1),null);
...
var vec__56673 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__56673,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__56673,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__56676 = cljs.core.rest.call(null,remaining_tokens);
var G__56677 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__56676;
name_tokens = G__56677;
continue;
} else {
...
var vec__56680 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__56680,(0),null);
var arity = cljs.core.nth.call(null,vec__56680,(1),null);
var vec__56683 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__56683,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__56683,(1),null);
var vec__56686 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__56686,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__56686,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__56686,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__56686,(3),null);
...
var vec__56692 = result;
var munged_ns = cljs.core.nth.call(null,vec__56692,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__56692,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__56692,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__56692,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__56692,(4),null);
var arity = cljs.core.nth.call(null,vec__56692,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__56696 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__56696,(0),null);
var args = cljs.core.nth.call(null,vec__56696,(1),null);
var vec__56699 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__56699,(0),null);
var name = cljs.core.nth.call(null,vec__56699,(1),null);
...
var G__56702 = (arity + (1));
var G__56703 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__56704){
var vec__56705 = p__56704;
var arity = cljs.core.nth.call(null,vec__56705,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__56705,(1),null);
...
return cljs.core.get.call(null,arities,p1__56708_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__56709_SHARP_);
...
var args__28371__auto__ = [];
var len__28364__auto___56716 = arguments.length;
var i__28365__auto___56717 = (0);
while(true){
if((i__28365__auto___56717 < len__28364__auto___56716)){
args__28371__auto__.push((arguments[i__28365__auto___56717]));

var G__56718 = (i__28365__auto___56717 + (1));
i__28365__auto___56717 = G__56718;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__56712){
var vec__56713 = p__56712;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__56713,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq56710){
var G__56711 = cljs.core.first.call(null,seq56710);
var seq56710__$1 = cljs.core.next.call(null,seq56710);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__56711,seq56710__$1);
});
...
var map__56721 = options;
var map__56721__$1 = ((((!((map__56721 == null)))?((((map__56721.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56721.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56721):map__56721);
var include_ns_QMARK_ = cljs.core.get.call(null,map__56721__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__56721__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__56721__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__56721__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__56722 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__56722,(0),null);
var fn_name = cljs.core.nth.call(null,vec__56722,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__56722,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__56722,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__56722,(4),null);
var arity = cljs.core.nth.call(null,vec__56722,(5),null);
...
}catch (e56726){var _e__38917__auto__ = e56726;
...
var G__56727 = (obj[cljs.core.first.call(null,path)]);
var G__56728 = cljs.core.rest.call(null,path);
obj = G__56727;
path = G__56728;
continue;
} else {
...
return (function (accum,p__56729){
var vec__56730 = p__56729;
var bit = cljs.core.nth.call(null,vec__56730,(0),null);
var protocol = cljs.core.nth.call(null,vec__56730,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__56733){
var vec__56734 = p__56733;
var ns = cljs.core.nth.call(null,vec__56734,(0),null);
var name = cljs.core.nth.call(null,vec__56734,(1),null);
var selector = cljs.core.nth.call(null,vec__56734,(2),null);
...
return (function (p__56738){
var vec__56739 = p__56738;
var munged_name = cljs.core.nth.call(null,vec__56739,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__56739,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__56739,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__56737_SHARP_){
return (obj[cljs.core.first.call(null,p1__56737_SHARP_)]);
});})(name,sorted_matches,vec__56739,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1513855135467
