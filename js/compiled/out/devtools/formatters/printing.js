...
var len__28364__auto___56773 = arguments.length;
var i__28365__auto___56774 = (0);
while(true){
if((i__28365__auto___56774 < len__28364__auto___56773)){
args__28371__auto__.push((arguments[i__28365__auto___56774]));

var G__56775 = (i__28365__auto___56774 + (1));
i__28365__auto___56774 = G__56775;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq56770){
var G__56771 = cljs.core.first.call(null,seq56770);
var seq56770__$1 = cljs.core.next.call(null,seq56770);
var G__56772 = cljs.core.first.call(null,seq56770__$1);
var seq56770__$2 = cljs.core.next.call(null,seq56770__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__56771,G__56772,seq56770__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__56776_SHARP_){
return !((cljs.core.meta.call(null,p1__56776_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__56777__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e56781){var _e__38917__auto__ = e56781;
return false;
}})();
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
...
}catch (e56783){var _e__38917__auto__ = e56783;
return false;
}}
})())){
...
var _STAR_current_state_STAR_56785 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__56786 = opts;
var map__56786__$1 = ((((!((map__56786 == null)))?((((map__56786.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56786.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56786):map__56786);
var markup_db = cljs.core.get.call(null,map__56786__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_56785;
}});
...
;
var temp__4655__auto___56790 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___56790)){
var managed_print_level_56791 = temp__4655__auto___56790;
var _STAR_print_level_STAR_56789_56792 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_56791;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_56789_56792,managed_print_level_56791,temp__4655__auto___56790,writer,opts,job_fn){
return (function (p1__56788_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__56788_SHARP_,null);
});})(_STAR_print_level_STAR_56789_56792,managed_print_level_56791,temp__4655__auto___56790,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_56789_56792;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1513855135653
