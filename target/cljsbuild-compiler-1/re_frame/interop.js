...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__13702 = cljs.core.instance_QMARK_;
var expr__13703 = reactive_val;
if(cljs.core.truth_((pred__13702.cljs$core$IFn$_invoke$arity$2 ? pred__13702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__13703) : pred__13702.call(null,reagent.ratom.RAtom,expr__13703)))){
return "ra";
} else {
if(cljs.core.truth_((pred__13702.cljs$core$IFn$_invoke$arity$2 ? pred__13702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__13703) : pred__13702.call(null,reagent.ratom.RCursor,expr__13703)))){
return "rc";
} else {
if(cljs.core.truth_((pred__13702.cljs$core$IFn$_invoke$arity$2 ? pred__13702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__13703) : pred__13702.call(null,reagent.ratom.Reaction,expr__13703)))){
return "rx";
} else {
if(cljs.core.truth_((pred__13702.cljs$core$IFn$_invoke$arity$2 ? pred__13702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__13703) : pred__13702.call(null,reagent.ratom.Track,expr__13703)))){
return "tr";
} else {
return "other";
}
