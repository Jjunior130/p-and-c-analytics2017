...
var vec__20137_20140 = clojure.data.diff(orig_db,new_db);
var only_before_20141 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20137_20140,(0),null);
var only_after_20142 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20137_20140,(1),null);
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only before:",only_before_20141], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only after :",only_after_20142], 0));
...
var map__20144 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20144__$1,cljs.core.cst$kw$db);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20144__$1,cljs.core.cst$kw$event);
...
var map__20146 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__20146__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20146__$1,cljs.core.cst$kw$event);
...
var len__8814__auto___20149 = arguments.length;
var i__8815__auto___20150 = (0);
while(true){
if((i__8815__auto___20150 < len__8814__auto___20149)){
args__8821__auto__.push((arguments[i__8815__auto___20150]));

var G__20151 = (i__8815__auto___20150 + (1));
i__8815__auto___20150 = G__20151;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq20148){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq20148));
});
...
var event = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$event);
var db = (function (){var or__7645__auto__ = re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$db);
...
var args__8821__auto__ = [];
var len__8814__auto___20157 = arguments.length;
var i__8815__auto___20158 = (0);
while(true){
if((i__8815__auto___20158 < len__8814__auto___20157)){
args__8821__auto__.push((arguments[i__8815__auto___20158]));

var G__20159 = (i__8815__auto___20158 + (1));
i__8815__auto___20158 = G__20159;
continue;
} else {
}
break;
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__20152_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,old_db,new_ins){
return (function (p1__20153_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__20153_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__7633__auto__ = cljs.core.contains_QMARK_(re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$1(context),cljs.core.cst$kw$db);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq20154){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__20155,G__20156,seq20154__$2);
});
