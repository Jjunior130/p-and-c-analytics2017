...
return cljs.core._conj((function (){var x__8507__auto____$1 = self__.val;
...
return cljs.core._write(writer__8271__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_16482 = (0);
while(true){
if((i_16482 < arr.length)){
(arr[i_16482] = null);

var G__16483 = (i_16482 + (1));
i_16482 = G__16483;
continue;
} else {
}
...
var i_16492 = (self__.level + (1));
while(true){
if((i_16492 <= (new_level + (1)))){
(update[i_16492] = self__.header);
...
var i_16494 = (0);
while(true){
if((i_16494 <= self__.level)){
var links_16495 = (update[i_16494]).forward;
if(((links_16495[i_16494]) === x__$1)){
(links_16495[i_16494] = (x__$1.forward[i_16494]));

var G__16496 = (i_16494 + (1));
i_16494 = G__16496;
continue;
} else {
var G__16497 = (i_16494 + (1));
i_16494 = G__16497;
continue;
}
} else {
...
if(!((nx == null))){
var G__16499 = nx;
var G__16500 = (level__$1 - (1));
x = G__16499;
level__$1 = G__16500;
continue;
} else {
var G__16501 = x;
var G__16502 = (level__$1 - (1));
x = G__16501;
level__$1 = G__16502;
continue;
}
...
var G__16504 = nx;
var G__16505 = (level__$1 - (1));
x = G__16504;
level__$1 = G__16505;
continue;
} else {
var G__16506 = x;
var G__16507 = (level__$1 - (1));
x = G__16506;
level__$1 = G__16507;
continue;
}
...
return cljs.core._write(writer__8271__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__7645__auto__,timeout,me){
return (function (){
