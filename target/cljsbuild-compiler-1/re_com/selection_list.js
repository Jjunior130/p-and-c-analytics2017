...
var G__19437_19438 = re_com.selection_list.check_clicked(selections,item_id,cljs.core.not((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id))),required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__19437_19438) : on_change.call(null,G__19437_19438));
}
...
var G__19439_19440 = re_com.selection_list.radio_clicked(selections,item_id,required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__19439_19440) : on_change.call(null,G__19439_19440));
}
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__19444){
...
var args = map__19445__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$disabled_QMARK_);
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$on_DASH_change);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$height);
var item_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$item_DASH_renderer);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$model);
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$label_DASH_fn);
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$required_QMARK_);
var as_exclusions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$as_DASH_exclusions_QMARK_);
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$max_DASH_height);
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$hide_DASH_border_QMARK_);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$width);
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$choices);
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$id_DASH_fn);
var multi_select_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19445__$1,cljs.core.cst$kw$multi_DASH_select_QMARK_);
...
var items = cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(item_renderer)?((function (selected,map__19445,map__19445__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__19441_SHARP_){
return (item_renderer.cljs$core$IFn$_invoke$arity$8 ? item_renderer.cljs$core$IFn$_invoke$arity$8(p1__19441_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_) : item_renderer.call(null,p1__19441_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_));
});})(selected,map__19445,map__19445__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__19445,map__19445__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__19442_SHARP_){
return re_com.selection_list.as_checked(p1__19442_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__19445,map__19445__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__19445,map__19445__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__19443_SHARP_){
return re_com.selection_list.as_radio(p1__19443_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__19445,map__19445__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__8814__auto___19454 = arguments.length;
var i__8815__auto___19455 = (0);
while(true){
if((i__8815__auto___19455 < len__8814__auto___19454)){
args__8821__auto__.push((arguments[i__8815__auto___19455]));

var G__19456 = (i__8815__auto___19455 + (1));
i__8815__auto___19455 = G__19456;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__19448){
...
var args = map__19449__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic(re_com.validate.extract_arg_data(re_com.selection_list.selection_list_args_desc),args,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["selection-list"], 0))))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__19449,map__19449__$1,args){
return (function() { 
var G__19457__delegate = function (p__19451){
...
while (G__19458__i < G__19458__a.length) {G__19458__a[G__19458__i] = arguments[G__19458__i + 0]; ++G__19458__i;}
  p__19451 = new cljs.core.IndexedSeq(G__19458__a,0,null);
} 
return G__19457__delegate.call(this,p__19451);};
G__19457.cljs$lang$maxFixedArity = 0;
G__19457.cljs$lang$applyTo = (function (arglist__19459){
var p__19451 = cljs.core.seq(arglist__19459);
return G__19457__delegate(p__19451);
});
G__19457.cljs$core$IFn$_invoke$arity$variadic = G__19457__delegate;
return G__19457;
})()
;
;})(map__19449,map__19449__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq19447){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19447));
});
