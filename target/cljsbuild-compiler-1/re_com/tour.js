...
return (function (p1__19420_SHARP_,p2__19421_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__19420_SHARP_,p2__19421_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
});})(tour_map))
,tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__8453__auto__ = (function re_com$tour$initialise_tour_$_iter__19422(s__19423){
return (new cljs.core.LazySeq(null,(function (){
var s__19423__$1 = s__19423;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__19423__$1);
if(temp__4657__auto__){
var s__19423__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__19423__$2)){
var c__8451__auto__ = cljs.core.chunk_first(s__19423__$2);
var size__8452__auto__ = cljs.core.count(c__8451__auto__);
var b__19425 = cljs.core.chunk_buffer(size__8452__auto__);
if((function (){var i__19424 = (0);
while(true){
if((i__19424 < size__8452__auto__)){
var step = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__8451__auto__,i__19424);
cljs.core.chunk_append(b__19425,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__19426 = (i__19424 + (1));
i__19424 = G__19426;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__19425),re_com$tour$initialise_tour_$_iter__19422(cljs.core.chunk_rest(s__19423__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__19425),null);
}
} else {
var step = cljs.core.first(s__19423__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__19422(cljs.core.rest(s__19423__$2)));
}
} else {
return null;
}
...
return iter__8453__auto__(cljs.core.cst$kw$steps.cljs$core$IFn$_invoke$arity$1(tour));
})());
});
/**
...
return cljs.core.reset_BANG_((function (){var fexpr__19427 = cljs.core.first(cljs.core.cst$kw$steps.cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__19427.cljs$core$IFn$_invoke$arity$1 ? fexpr__19427.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__19427.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__19428 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__19428.cljs$core$IFn$_invoke$arity$1 ? fexpr__19428.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__19428.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__19429 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__19429.cljs$core$IFn$_invoke$arity$1 ? fexpr__19429.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__19429.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__19430 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__19430.cljs$core$IFn$_invoke$arity$1 ? fexpr__19430.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__19430.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__19431 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__19431.cljs$core$IFn$_invoke$arity$1 ? fexpr__19431.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__19431.call(null,tour));
})(),true);
} else {
return null;
}
