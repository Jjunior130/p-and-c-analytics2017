...
var G__19462 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(choices,new_index);
return (id_fn.cljs$core$IFn$_invoke$arity$1 ? id_fn.cljs$core$IFn$_invoke$arity$1(G__19462) : id_fn.call(null,G__19462));
} else {
return null;
}
});
...
return cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$id,cljs.core.cst$kw$group],[cljs.core.gensym.cljs$core$IFn$_invoke$arity$0(),p1__19463_SHARP_]);
});})(groups))
...
var or__7645__auto__ = re__$1.test((group_fn.cljs$core$IFn$_invoke$arity$1 ? group_fn.cljs$core$IFn$_invoke$arity$1(opt) : group_fn.call(null,opt)));
...
var G__19465_19466 = event.target.value;
(set_filter_text.cljs$core$IFn$_invoke$arity$1 ? set_filter_text.cljs$core$IFn$_invoke$arity$1(G__19465_19466) : set_filter_text.call(null,G__19465_19466));
 ...
 */
re_com.dropdown.filter_text_box = cljs.core.with_meta(re_com.dropdown.filter_text_box_base,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$component_DASH_did_DASH_mount,(function (p1__19467_SHARP_){
var node = reagent.core.dom_node(p1__19467_SHARP_).firstChild;
return node.focus();
}),cljs.core.cst$kw$component_DASH_did_DASH_update,(function (p1__19468_SHARP_){
var node = reagent.core.dom_node(p1__19468_SHARP_).firstChild;
return node.focus();
})], null));
/**
...
var text = (cljs.core.truth_(cljs.core.deref(internal_model))?(function (){var G__19469 = re_com.util.item_for_id.cljs$core$IFn$_invoke$arity$variadic(cljs.core.deref(internal_model),choices,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$id_DASH_fn,id_fn], 0));
return (label_fn.cljs$core$IFn$_invoke$arity$1 ? label_fn.cljs$core$IFn$_invoke$arity$1(G__19469) : label_fn.call(null,G__19469));
})():placeholder);
...
var or__7645__auto__ = cljs.core.fn_QMARK_(v);
if(or__7645__auto__){
return or__7645__auto__;
} else {
...
var map__19473__$1 = ((((!((map__19473 == null)))?((((map__19473.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19473.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19473):map__19473);
var args = map__19473__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19473__$1,cljs.core.cst$kw$result);
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19473__$1,cljs.core.cst$kw$error);
...
var G__19475 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$filter_DASH_text,text,cljs.core.cst$kw$regex_DASH_filter_QMARK_,regex_filter_QMARK_], null);
var G__19476 = ((function (G__19475,id,callback){
return (function (p1__19470_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$result,p1__19470_SHARP_], null));
});})(G__19475,id,callback))
;
var G__19477 = ((function (G__19475,G__19476,id,callback){
return (function (p1__19471_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$error,p1__19471_SHARP_], null));
});})(G__19475,G__19476,id,callback))
;
return (choices.cljs$core$IFn$_invoke$arity$3 ? choices.cljs$core$IFn$_invoke$arity$3(G__19475,G__19476,G__19477) : choices.call(null,G__19475,G__19476,G__19477));
});
/**
...
var temp__4657__auto___19480 = cljs.core.cst$kw$timer.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
if(cljs.core.truth_(temp__4657__auto___19480)){
var timer_19481 = temp__4657__auto___19480;
clearTimeout(timer_19481);
} else {
}

if(cljs.core.truth_(debounce_QMARK_)){
var timer = (function (){var G__19478 = (function (){
return re_com.dropdown.load_choices_STAR_(choices_state,choices,text,regex_filter_QMARK_);
});
var G__19479 = debounce_delay;
return setTimeout(G__19478,G__19479);
})();
...
var len__8814__auto___19502 = arguments.length;
var i__8815__auto___19503 = (0);
while(true){
if((i__8815__auto___19503 < len__8814__auto___19502)){
args__8821__auto__.push((arguments[i__8815__auto___19503]));

var G__19504 = (i__8815__auto___19503 + (1));
i__8815__auto___19503 = G__19504;
continue;
} else {
}
break;
...
re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic = (function (p__19487){
...
var args = map__19488__$1;
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19488__$1,cljs.core.cst$kw$choices);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19488__$1,cljs.core.cst$kw$model);
var regex_filter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19488__$1,cljs.core.cst$kw$regex_DASH_filter_QMARK_);
var debounce_delay = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19488__$1,cljs.core.cst$kw$debounce_DASH_delay,(250));
...
var set_filter_text = ((function (external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (text,p__19490,debounce_QMARK_){
...
var args__$1 = map__19491__$1;
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19491__$1,cljs.core.cst$kw$regex_DASH_filter_QMARK_);
...
});})(external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
;
...
return ((function (external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function() { 
var G__19505__delegate = function (p__19493){
...
var args__$1 = map__19494__$1;
var group_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19494__$1,cljs.core.cst$kw$group_DASH_fn,cljs.core.cst$kw$group);
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$disabled_QMARK_);
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$on_DASH_change);
var model__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$model);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$attr);
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19494__$1,cljs.core.cst$kw$label_DASH_fn,cljs.core.cst$kw$label);
var tab_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$tab_DASH_index);
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$max_DASH_height);
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$placeholder);
var title_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$title_QMARK_);
var render_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19494__$1,cljs.core.cst$kw$render_DASH_fn,label_fn);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$width);
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$regex_DASH_filter_QMARK_);
var choices__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$choices);
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19494__$1,cljs.core.cst$kw$id_DASH_fn,cljs.core.cst$kw$id);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$style);
var debounce_delay__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$debounce_DASH_delay);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$class);
var filter_box_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19494__$1,cljs.core.cst$kw$filter_DASH_box_QMARK_);
...
var callback = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (p1__19482_SHARP_){
cljs.core.reset_BANG_(internal_model,p1__19482_SHARP_);
...
var G__19496_19506 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__19496_19506) : on_change.call(null,G__19496_19506));
} else {
}
...
});})(choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
;
var cancel = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
cljs.core.reset_BANG_(drop_showing_QMARK_,false);
...
});})(choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
;
var dropdown_click = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
...
var press_enter = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
if(cljs.core.truth_(disabled_QMARK___$1)){
cancel();
} else {
...
;
var press_escape = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
cancel();
...
;
var press_tab = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
if(cljs.core.truth_(disabled_QMARK___$1)){
cancel();
} else {
if(cljs.core.truth_(changeable_QMARK_)){
var G__19497_19507 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__19497_19507) : on_change.call(null,G__19497_19507));
} else {
}
...
;
var press_down = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
if(cljs.core.truth_(cljs.core.deref(drop_showing_QMARK_))){
cljs.core.reset_BANG_(internal_model,re_com.dropdown.move_to_new_choice(filtered_choices,id_fn,cljs.core.deref(internal_model),(1)));
} else {
...
;
var press_home = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
...
;
var press_end = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
...
;
var key_handler = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (p1__19483_SHARP_){
if(cljs.core.truth_(disabled_QMARK___$1)){
return false;
} else {
var G__19498 = p1__19483_SHARP_.which;
switch (G__19498) {
case (13):
return press_enter();
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$chosen_DASH_drop,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.dropdown.filter_text_box,filter_box_QMARK_,filter_text,key_handler,drop_showing_QMARK_,((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,key_handler,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (p1__19484_SHARP_){
return set_filter_text(p1__19484_SHARP_,args__$1,true);
});})(choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,key_handler,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$ul$chosen_DASH_results,(cljs.core.truth_(max_height)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$max_DASH_height,max_height], null)], null):null),(cljs.core.truth_((function (){var and__7633__auto__ = choices_fn_QMARK_;
if(and__7633__auto__){
return cljs.core.cst$kw$loading_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
} else {
return and__7633__auto__;
}
})())?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li$loading,["Loading..."].join('')], null):(cljs.core.truth_((function (){var and__7633__auto__ = choices_fn_QMARK_;
if(and__7633__auto__){
return cljs.core.cst$kw$error.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
} else {
return and__7633__auto__;
}
})())?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li$error,cljs.core.cst$kw$error.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state))], null):(((cljs.core.count(filtered_choices) > (0)))?(function (){var vec__19499 = re_com.dropdown.choices_with_group_headings(filtered_choices,group_fn);
var group_names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19499,(0),null);
var group_opt_lists = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19499,(1),null);
...
var make_choices = ((function (vec__19499,group_names,group_opt_lists,make_a_choice,choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,key_handler,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (p1__19485_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(make_a_choice,p1__19485_SHARP_);
});})(vec__19499,group_names,group_opt_lists,make_a_choice,choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,key_handler,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
;
var make_h_then_choices = ((function (vec__19499,group_names,group_opt_lists,make_a_choice,make_choices,choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,key_handler,map__19494,map__19494__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
...
while (G__19509__i < G__19509__a.length) {G__19509__a[G__19509__i] = arguments[G__19509__i + 0]; ++G__19509__i;}
  p__19493 = new cljs.core.IndexedSeq(G__19509__a,0,null);
} 
return G__19505__delegate.call(this,p__19493);};
G__19505.cljs$lang$maxFixedArity = 0;
G__19505.cljs$lang$applyTo = (function (arglist__19510){
var p__19493 = cljs.core.seq(arglist__19510);
return G__19505__delegate(p__19493);
});
G__19505.cljs$core$IFn$_invoke$arity$variadic = G__19505__delegate;
return G__19505;
})()
;
;})(external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__19488,map__19488__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
});

re_com.dropdown.single_dropdown.cljs$lang$maxFixedArity = (0);

re_com.dropdown.single_dropdown.cljs$lang$applyTo = (function (seq19486){
return re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19486));
});
