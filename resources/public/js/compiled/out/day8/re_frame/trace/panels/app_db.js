...
return cljs.core.reduce.call(null,(function (acc,p__42698){
var vec__42699 = p__42698;
var property = cljs.core.nth.call(null,vec__42699,(0),null);
var value = cljs.core.nth.call(null,vec__42699,(1),null);
return cljs.core.assoc.call(null,acc,cljs.core.keyword.call(null,property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__42697_SHARP_){
return clojure.string.split.call(null,p1__42697_SHARP_,/:/);
...
var len__28364__auto___42704 = arguments.length;
var i__28365__auto___42705 = (0);
while(true){
if((i__28365__auto___42705 < len__28364__auto___42704)){
args__28371__auto__.push((arguments[i__28365__auto___42705]));

var G__42706 = (i__28365__auto___42705 + (1));
i__28365__auto___42705 = G__42706;
continue;
} else {
}
break;
...
var previous_config__42688__auto__ = devtools.prefs.get_prefs.call(null);
var prefs__42689__auto__ = day8.re_frame.trace.panels.app_db.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_.call(null,prefs__42689__auto__);

return cljs.core.apply.call(null,api_fn,args);
}finally {if(cljs.core._EQ_.call(null,devtools.prefs.get_prefs.call(null),prefs__42689__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__42689__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_.call(null,previous_config__42688__auto__);
}});

day8.re_frame.trace.panels.app_db.make_devtools_api_call.cljs$lang$maxFixedArity = (1);

day8.re_frame.trace.panels.app_db.make_devtools_api_call.cljs$lang$applyTo = (function (seq42702){
var G__42703 = cljs.core.first.call(null,seq42702);
var seq42702__$1 = cljs.core.next.call(null,seq42702);
return day8.re_frame.trace.panels.app_db.make_devtools_api_call.cljs$core$IFn$_invoke$arity$variadic(G__42703,seq42702__$1);
});
...
var args__28371__auto__ = [];
var len__28364__auto___42708 = arguments.length;
var i__28365__auto___42709 = (0);
while(true){
if((i__28365__auto___42709 < len__28364__auto___42708)){
args__28371__auto__.push((arguments[i__28365__auto___42709]));

var G__42710 = (i__28365__auto___42709 + (1));
i__28365__auto___42709 = G__42710;
continue;
} else {
}
break;
...
day8.re_frame.trace.panels.app_db.cljs_devtools_header.cljs$lang$applyTo = (function (seq42707){
return day8.re_frame.trace.panels.app_db.cljs_devtools_header.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq42707));
});
...
var args__28371__auto__ = [];
var len__28364__auto___42712 = arguments.length;
var i__28365__auto___42713 = (0);
while(true){
if((i__28365__auto___42713 < len__28364__auto___42712)){
args__28371__auto__.push((arguments[i__28365__auto___42713]));

var G__42714 = (i__28365__auto___42713 + (1));
i__28365__auto___42713 = G__42714;
continue;
} else {
}
break;
...
day8.re_frame.trace.panels.app_db.cljs_devtools_body.cljs$lang$applyTo = (function (seq42711){
return day8.re_frame.trace.panels.app_db.cljs_devtools_body.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq42711));
});
...
var args__28371__auto__ = [];
var len__28364__auto___42716 = arguments.length;
var i__28365__auto___42717 = (0);
while(true){
if((i__28365__auto___42717 < len__28364__auto___42716)){
args__28371__auto__.push((arguments[i__28365__auto___42717]));

var G__42718 = (i__28365__auto___42717 + (1));
i__28365__auto___42717 = G__42718;
continue;
} else {
}
break;
...
day8.re_frame.trace.panels.app_db.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq42715){
return day8.re_frame.trace.panels.app_db.cljs_devtools_has_body.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq42715));
});
...
var vec__42719 = jsonml;
var seq__42720 = cljs.core.seq.call(null,vec__42719);
var first__42721 = cljs.core.first.call(null,seq__42720);
var seq__42720__$1 = cljs.core.next.call(null,seq__42720);
var tag_name = first__42721;
var first__42721__$1 = cljs.core.first.call(null,seq__42720__$1);
var seq__42720__$2 = cljs.core.next.call(null,seq__42720__$1);
var attributes = first__42721__$1;
var children = seq__42720__$2;
...
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","add-path","app-db/add-path",679847590),p1__42722_SHARP_], null));
});})(subtree_input,subtree_paths,search_string,input_error))
...
//# sourceMappingURL=app_db.js.map?rel=1514349647908
