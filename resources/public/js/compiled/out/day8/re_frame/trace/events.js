...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("settings","panel-width%","settings/panel-width%",-1897072808),(function (db,p__42813){
var vec__42814 = p__42813;
var _ = cljs.core.nth.call(null,vec__42814,(0),null);
var width_PERCENT_ = cljs.core.nth.call(null,vec__42814,(1),null);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("settings","selected-tab","settings/selected-tab",-124010089),(function (db,p__42817){
var vec__42818 = p__42817;
var _ = cljs.core.nth.call(null,vec__42818,(0),null);
var selected_tab = cljs.core.nth.call(null,vec__42818,(1),null);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("settings","show-panel?","settings/show-panel?",-194286945),(function (db,p__42821){
var vec__42822 = p__42821;
var _ = cljs.core.nth.call(null,vec__42822,(0),null);
var show_panel_QMARK_ = cljs.core.nth.call(null,vec__42822,(1),null);
...
var map__42825 = new cljs.core.Keyword(null,"prefs","prefs",-1818938470).cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var map__42825__$1 = ((((!((map__42825 == null)))?((((map__42825.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42825.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42825):map__42825);
var ext_height = cljs.core.get.call(null,map__42825__$1,new cljs.core.Keyword(null,"ext_height","ext_height",-46169089));
var ext_width = cljs.core.get.call(null,map__42825__$1,new cljs.core.Keyword(null,"ext_width","ext_width",925500566));
...
(w["onload"] = ((function (map__42825,map__42825__$1,ext_height,ext_width,w,d){
return (function (){
return day8.re_frame.trace.events.mount.call(null,w,d);
});})(map__42825,map__42825__$1,ext_height,ext_width,w,d))
);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("global","unloading?","global/unloading?",-351325001),(function (db,p__42827){
var vec__42828 = p__42827;
var _ = cljs.core.nth.call(null,vec__42828,(0),null);
var unloading_QMARK_ = cljs.core.nth.call(null,vec__42828,(1),null);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("traces","filter-items","traces/filter-items",977390347),(function (db,p__42831){
var vec__42832 = p__42831;
var _ = cljs.core.nth.call(null,vec__42832,(0),null);
var filter_items = cljs.core.nth.call(null,vec__42832,(1),null);
...
var _ = cljs.core.nth.call(null,vec__42839,(0),null);
var filter_input = cljs.core.nth.call(null,vec__42839,(1),null);
var filter_type = cljs.core.nth.call(null,vec__42839,(2),null);
var new_db = (cljs.core.truth_(cljs.core.some.call(null,((function (vec__42839,_,filter_input,filter_type){
return (function (p1__42835_SHARP_){
return cljs.core._EQ_.call(null,filter_input,new cljs.core.Keyword(null,"query","query",-1288509510).cljs$core$IFn$_invoke$arity$1(p1__42835_SHARP_));
});})(vec__42839,_,filter_input,filter_type))
...
return cljs.core.some.call(null,((function (and__27183__auto__,vec__42839,_,filter_input,filter_type){
return (function (p1__42836_SHARP_){
return cljs.core._EQ_.call(null,filter_type,new cljs.core.Keyword(null,"filter-type","filter-type",1785113735).cljs$core$IFn$_invoke$arity$1(p1__42836_SHARP_));
});})(and__27183__auto__,vec__42839,_,filter_input,filter_type))
,filter_items);
} else {
return and__27183__auto__;
}
})())){
cljs.core.remove.call(null,((function (vec__42839,_,filter_input,filter_type){
return (function (p1__42837_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"slower-than","slower-than",1137227767),new cljs.core.Keyword(null,"filter-type","filter-type",1785113735).cljs$core$IFn$_invoke$arity$1(p1__42837_SHARP_));
});})(vec__42839,_,filter_input,filter_type))
,filter_items);
} else {
}
...
var _ = cljs.core.nth.call(null,vec__42844,(0),null);
var filter_id = cljs.core.nth.call(null,vec__42844,(1),null);
var new_db = cljs.core.remove.call(null,((function (vec__42844,_,filter_id){
return (function (p1__42842_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__42842_SHARP_),filter_id);
});})(vec__42844,_,filter_id))
,filter_items);
day8.re_frame.trace.events.save_filter_items.call(null,new_db);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("app-db","paths","app-db/paths",-1600032730),(function (db,p__42847){
var vec__42848 = p__42847;
var _ = cljs.core.nth.call(null,vec__42848,(0),null);
var paths = cljs.core.nth.call(null,vec__42848,(1),null);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("app-db","remove-path","app-db/remove-path",-1233894231),(function (db,p__42852){
var vec__42853 = p__42852;
var _ = cljs.core.nth.call(null,vec__42853,(0),null);
var path = cljs.core.nth.call(null,vec__42853,(1),null);
var new_db = cljs.core.update_in.call(null,db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"paths","paths",-1807389588)], null),((function (vec__42853,_,path){
return (function (p1__42851_SHARP_){
return cljs.core.remove.call(null,((function (vec__42853,_,path){
return (function (p){
...
return cljs.core.cons.call(null,path,p1__42856_SHARP_);
});})(search_string,path))
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("app-db","search-string","app-db/search-string",939397656),(function (db,p__42858){
var vec__42859 = p__42858;
var _ = cljs.core.nth.call(null,vec__42859,(0),null);
var search_string = cljs.core.nth.call(null,vec__42859,(1),null);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("app-db","set-json-ml-paths","app-db/set-json-ml-paths",582043654),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [mranderson047.re_frame.v0v10v2.re_frame.core.path.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"json-ml-expansions","json-ml-expansions",1112306261)], null))], null),(function (db,p__42862){
var vec__42863 = p__42862;
var _ = cljs.core.nth.call(null,vec__42863,(0),null);
var paths = cljs.core.nth.call(null,vec__42863,(1),null);
day8.re_frame.trace.utils.localstorage.save_BANG_.call(null,"app-db-json-ml-expansions",paths);

return paths;
}));
mranderson047.re_frame.v0v10v2.re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [mranderson047.re_frame.v0v10v2.re_frame.core.path.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"json-ml-expansions","json-ml-expansions",1112306261)], null))], null),(function (paths,p__42866){
var vec__42867 = p__42866;
var _ = cljs.core.nth.call(null,vec__42867,(0),null);
var path = cljs.core.nth.call(null,vec__42867,(1),null);
...
//# sourceMappingURL=events.js.map?rel=1513846763469
