...
goog.provide('day8.re_frame.trace.panels.subvis');
goog.require('cljs.core');
goog.require('cljsjs.d3');
goog.require('day8.re_frame.trace.components.d3');
goog.require('day8.re_frame.trace.utils.graph');
goog.require('reagent.core');
goog.require('re_frame.interop');
goog.require('re_frame.db');
goog.require('goog.object');
goog.require('clojure.set');
day8.re_frame.trace.panels.subvis.width = (400);
day8.re_frame.trace.panels.subvis.height = (400);
day8.re_frame.trace.panels.subvis.prev_graph = cljs.core.atom.call(null,null);
day8.re_frame.trace.panels.subvis.mygraph = reagent.core.atom.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"nodes","nodes",-2099585805),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"group","group",582596132),(1)], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),(2),new cljs.core.Keyword(null,"group","group",582596132),(1)], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),(3),new cljs.core.Keyword(null,"group","group",582596132),(2)], null)], null),new cljs.core.Keyword(null,"links","links",-654507394),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"source","source",-433931539),(1),new cljs.core.Keyword(null,"target","target",253001721),(2),new cljs.core.Keyword(null,"value","value",305978217),(1)], null)], null)], null));
day8.re_frame.trace.panels.subvis.app_db_node = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),re_frame.interop.reagent_id.call(null,re_frame.db.app_db),new cljs.core.Keyword(null,"title","title",636505583),"app-db",new cljs.core.Keyword(null,"group","group",582596132),(1),new cljs.core.Keyword(null,"r","r",-471384190),(20),new cljs.core.Keyword(null,"fx","fx",-1237829572),(15),new cljs.core.Keyword(null,"fy","fy",550788984),(day8.re_frame.trace.panels.subvis.height / (2))], null);
day8.re_frame.trace.panels.subvis.render_node_QMARK_ = (function day8$re_frame$trace$panels$subvis$render_node_QMARK_(d){
 ...
 */
day8.re_frame.trace.panels.subvis.min_max = (function day8$re_frame$trace$panels$subvis$min_max(min_val,x,max_val){
if((min_val <= max_val)){
} else {
throw (new Error("Assert failed: (<= min-val max-val)"));
}

var x__27545__auto__ = min_val;
var y__27546__auto__ = (function (){var x__27552__auto__ = x;
var y__27553__auto__ = max_val;
...
day8.re_frame.trace.panels.subvis.render_subvis = (function day8$re_frame$trace$panels$subvis$render_subvis(traces_ratom){
...
return (function (p1__42743_SHARP_){
return p1__42743_SHARP_.id;
...
return (function (ratom){
var old_g = cljs.core.deref.call(null,day8.re_frame.trace.panels.subvis.prev_graph);
var graph = cljs.core.reset_BANG_.call(null,day8.re_frame.trace.panels.subvis.prev_graph,day8.re_frame.trace.utils.graph.trace__GT_sub_graph.call(null,cljs.core.deref.call(null,ratom),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame.trace.panels.subvis.app_db_node], null)));
...
var graph__$1 = day8.re_frame.trace.utils.graph.trace__GT_sub_graph.call(null,cljs.core.deref.call(null,ratom),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame.trace.panels.subvis.app_db_node], null));
...
return (function (d){
if(cljs.core.truth_(day8.re_frame.trace.panels.subvis.render_node_QMARK_.call(null,d))){
return (-12);
} else {
return (12);
}
...
return (function (d){
var r = d.r;
var x = day8.re_frame.trace.panels.subvis.min_max.call(null,r,d.x,(day8.re_frame.trace.panels.subvis.width - r));
var y = day8.re_frame.trace.panels.subvis.min_max.call(null,r,d.y,(day8.re_frame.trace.panels.subvis.height - r));
d.x = x;
...
//# sourceMappingURL=subvis.js.map?rel=1513846763131
