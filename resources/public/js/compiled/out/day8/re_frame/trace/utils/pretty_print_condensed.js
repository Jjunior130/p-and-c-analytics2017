...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,string,(0),(function (){var G__42752 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42750__$1)].join('')));
...
var G__42759 = clojure.string.replace.call(null,s,match,trunc_prefix);
var G__42760 = limit;
var G__42761 = match;
var G__42762 = trunc_prefix;
s = G__42759;
limit = G__42760;
match = G__42761;
trunc_prefix = G__42762;
continue;
}
}
break;
...
var prefix = (function (){var G__42763 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42763),"\u2026/"].join('');
} else {
return G__42763;
}
})();
...
var vec__42765 = day8.re_frame.trace.utils.pretty_print_condensed.edges.call(null,coll);
var left = cljs.core.nth.call(null,vec__42765,(0),null);
var right = cljs.core.nth.call(null,vec__42765,(1),null);
...
var or__27195__auto__ = (function (){var G__42772 = form.name;
if((G__42772 == null)){
return null;
} else {
return clojure.string.replace.call(null,G__42772,/(^.*\$)(.*)/,"$2");
}
})();
...
//# sourceMappingURL=pretty_print_condensed.js.map?rel=1513846763201
