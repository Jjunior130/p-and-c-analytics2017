...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__43132 = cljs.core.instance_QMARK_;
var expr__43133 = reactive_val;
if(cljs.core.truth_(pred__43132.call(null,reagent.ratom.RAtom,expr__43133))){
return "ra";
} else {
if(cljs.core.truth_(pred__43132.call(null,reagent.ratom.RCursor,expr__43133))){
return "rc";
} else {
if(cljs.core.truth_(pred__43132.call(null,reagent.ratom.Reaction,expr__43133))){
return "rx";
} else {
if(cljs.core.truth_(pred__43132.call(null,reagent.ratom.Track,expr__43133))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1513978687275
