...
return (new CustomEvent(event_name,(function (){var obj53595 = {"detail":data};
return obj53595;
})()));
} else {
...
var f = (function (){var pred__53602 = cljs.core._EQ_;
var expr__53603 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__53602.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__53603))){
return ((function (pred__53602,expr__53603){
return (function (p1__53596_SHARP_){
return console.warn(p1__53596_SHARP_);
});
;})(pred__53602,expr__53603))
} else {
if(cljs.core.truth_(pred__53602.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__53603))){
return ((function (pred__53602,expr__53603){
return (function (p1__53597_SHARP_){
return console.debug(p1__53597_SHARP_);
});
;})(pred__53602,expr__53603))
} else {
if(cljs.core.truth_(pred__53602.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__53603))){
return ((function (pred__53602,expr__53603){
return (function (p1__53598_SHARP_){
return console.error(p1__53598_SHARP_);
});
;})(pred__53602,expr__53603))
} else {
return ((function (pred__53602,expr__53603){
return (function (p1__53599_SHARP_){
return console.log(p1__53599_SHARP_);
});
;})(pred__53602,expr__53603))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__53606){
...
var opts = map__53607__$1;
var eval_fn = cljs.core.get.call(null,map__53607__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__53609_SHARP_){
return new_def.callback(p1__53609_SHARP_);
});})(new_def))
);
...
return (function (p__53610){
var vec__53611 = p__53610;
var ky = cljs.core.nth.call(null,vec__53611,(0),null);
var v = cljs.core.nth.call(null,vec__53611,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1513855130836
