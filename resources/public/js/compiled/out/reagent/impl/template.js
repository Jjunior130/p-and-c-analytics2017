...
var G__38811 = o;
(G__38811[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38812__delegate = function (args){
...
return G__38812__delegate.call(this,args);};
...
return G__38812__delegate(args);
});
...
var G__38817 = jsprops;
(G__38817["defaultValue"] = value);

(G__38817["onChange"] = ((function (G__38817,v,value,on_change){
return (function (p1__38816_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38816_SHARP_);
});})(G__38817,v,value,on_change))
);
...
var vec__38820 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38820,(0),null);
var id = cljs.core.nth.call(null,vec__38820,(1),null);
var class$ = cljs.core.nth.call(null,vec__38820,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___38824 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___38824 == null)){
} else {
var key_38825 = temp__4661__auto___38824;
(jsprops["key"] = key_38825);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__38826 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__38826["name"] = c);
...
var len__28364__auto___38831 = arguments.length;
var i__28365__auto___38832 = (0);
while(true){
if((i__28365__auto___38832 < len__28364__auto___38831)){
args__28371__auto__.push((arguments[i__28365__auto___38832]));

var G__38833 = (i__28365__auto___38832 + (1));
i__28365__auto___38832 = G__38833;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38829){
var G__38830 = cljs.core.first.call(null,seq38829);
var seq38829__$1 = cljs.core.next.call(null,seq38829);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__38830,seq38829__$1);
});
...
break;
default:
var G__38836 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38836;
continue;
...
var n__28140__auto___38838 = a.length;
var i_38839 = (0);
while(true){
if((i_38839 < n__28140__auto___38838)){
(a[i_38839] = reagent.impl.template.as_element.call(null,(a[i_38839])));

var G__38840 = (i_38839 + (1));
i_38839 = G__38840;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__28140__auto___38841 = a.length;
var i_38842 = (0);
while(true){
if((i_38842 < n__28140__auto___38841)){
var val_38843 = (a[i_38842]);
if((cljs.core.vector_QMARK_.call(null,val_38843)) && ((reagent.impl.template.key_from_vec.call(null,val_38843) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38842] = reagent.impl.template.as_element.call(null,val_38843));

var G__38844 = (i_38842 + (1));
i_38842 = G__38844;
continue;
} else {
}
...
var ctx = ({});
var vec__38845 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__38845,(0),null);
var derefed = cljs.core.nth.call(null,vec__38845,(1),null);
...
var G__38848 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38848) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38848){
...
//# sourceMappingURL=template.js.map?rel=1514349639918
