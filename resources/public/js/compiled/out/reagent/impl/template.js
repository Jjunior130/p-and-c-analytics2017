...
var G__38758 = o;
(G__38758[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38759__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__38759 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38760__i = 0, G__38760__a = new Array(arguments.length -  0);
while (G__38760__i < G__38760__a.length) {G__38760__a[G__38760__i] = arguments[G__38760__i + 0]; ++G__38760__i;}
  args = new cljs.core.IndexedSeq(G__38760__a,0,null);
} 
return G__38759__delegate.call(this,args);};
G__38759.cljs$lang$maxFixedArity = 0;
G__38759.cljs$lang$applyTo = (function (arglist__38761){
var args = cljs.core.seq(arglist__38761);
return G__38759__delegate(args);
});
G__38759.cljs$core$IFn$_invoke$arity$variadic = G__38759__delegate;
return G__38759;
})()
;
} else {
...
var G__38764 = jsprops;
(G__38764["defaultValue"] = value);

(G__38764["onChange"] = ((function (G__38764,v,value,on_change){
return (function (p1__38763_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38763_SHARP_);
});})(G__38764,v,value,on_change))
);
...
var vec__38767 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38767,(0),null);
var id = cljs.core.nth.call(null,vec__38767,(1),null);
var class$ = cljs.core.nth.call(null,vec__38767,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___38771 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___38771 == null)){
} else {
var key_38772 = temp__4661__auto___38771;
(jsprops["key"] = key_38772);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__38773 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__38773["name"] = c);
...
var len__28364__auto___38778 = arguments.length;
var i__28365__auto___38779 = (0);
while(true){
if((i__28365__auto___38779 < len__28364__auto___38778)){
args__28371__auto__.push((arguments[i__28365__auto___38779]));

var G__38780 = (i__28365__auto___38779 + (1));
i__28365__auto___38779 = G__38780;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38776){
var G__38777 = cljs.core.first.call(null,seq38776);
var seq38776__$1 = cljs.core.next.call(null,seq38776);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__38777,seq38776__$1);
});
...
break;
default:
var G__38783 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38783;
continue;
...
var n__28140__auto___38785 = a.length;
var i_38786 = (0);
while(true){
if((i_38786 < n__28140__auto___38785)){
(a[i_38786] = reagent.impl.template.as_element.call(null,(a[i_38786])));

var G__38787 = (i_38786 + (1));
i_38786 = G__38787;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__28140__auto___38788 = a.length;
var i_38789 = (0);
while(true){
if((i_38789 < n__28140__auto___38788)){
var val_38790 = (a[i_38789]);
if((cljs.core.vector_QMARK_.call(null,val_38790)) && ((reagent.impl.template.key_from_vec.call(null,val_38790) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38789] = reagent.impl.template.as_element.call(null,val_38790));

var G__38791 = (i_38789 + (1));
i_38789 = G__38791;
continue;
} else {
}
...
var ctx = ({});
var vec__38792 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__38792,(0),null);
var derefed = cljs.core.nth.call(null,vec__38792,(1),null);
...
var G__38795 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38795) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38795){
...
//# sourceMappingURL=template.js.map?rel=1513846757109
