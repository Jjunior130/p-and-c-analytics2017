...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41591){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__41592,G__41593,seq41591__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41597_SHARP_){
return !((cljs.core.meta.call(null,p1__41597_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__41598__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41602){var _e__40614__auto__ = e41602;
return false;
}})();
if(cljs.core.truth_(or__27195__auto__)){
return or__27195__auto__;
...
}catch (e41604){var _e__40614__auto__ = e41604;
return false;
}}
})())){
...
var _STAR_current_state_STAR_41606 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__41607 = opts;
...
var markup_db = cljs.core.get.call(null,map__41607__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_41606;
}});
...
;
var temp__4655__auto___41611 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___41611)){
var managed_print_level_41612 = temp__4655__auto___41611;
var _STAR_print_level_STAR_41610_41613 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_41612;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_41610_41613,managed_print_level_41612,temp__4655__auto___41611,writer,opts,job_fn){
return (function (p1__41609_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__41609_SHARP_,null);
});})(_STAR_print_level_STAR_41610_41613,managed_print_level_41612,temp__4655__auto___41611,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_41610_41613;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1513978684842
