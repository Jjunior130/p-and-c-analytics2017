...
var temp__4655__auto____$1 = (o39766["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39767 = temp__4655__auto____$1;
return (o39767["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__38910__auto___39770 = t;
(o__38910__auto___39770["cljs$lang$ctorPrWriter"]).call(o__38910__auto___39770,t,writer);
}catch (e39769){var __39771 = e39769;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39772 = num_code;
switch (G__39772) {
case (1):
return (185);
...
}catch (e39774){var _e__38917__auto__ = e39774;
return false;
}})())){
...
var vec__39775 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39775,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o39778 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39778["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39779 = temp__4655__auto____$1;
return (o39779["nameToPath"]);
} else {
return null;
}
} else {
...
var len__28364__auto___39786 = arguments.length;
var i__28365__auto___39787 = (0);
while(true){
if((i__28365__auto___39787 < len__28364__auto___39786)){
args__28371__auto__.push((arguments[i__28365__auto___39787]));

var G__39788 = (i__28365__auto___39787 + (1));
i__28365__auto___39787 = G__39788;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39782){
var vec__39783 = p__39782;
var ns_detector = cljs.core.nth.call(null,vec__39783,(0),null);
...
var G__39789 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39790 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39789;
remaining_tokens = G__39790;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39780){
var G__39781 = cljs.core.first.call(null,seq39780);
var seq39780__$1 = cljs.core.next.call(null,seq39780);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__39781,seq39780__$1);
});
...
var vec__39794 = cljs.core.split_with.call(null,(function (p1__39793_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39793_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39794,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39794,(1),null);
...
var vec__39797 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39797,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39797,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39800 = cljs.core.rest.call(null,remaining_tokens);
var G__39801 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39800;
name_tokens = G__39801;
continue;
} else {
...
var vec__39804 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39804,(0),null);
var arity = cljs.core.nth.call(null,vec__39804,(1),null);
var vec__39807 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39807,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39807,(1),null);
var vec__39810 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39810,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39810,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39810,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39810,(3),null);
...
var vec__39816 = result;
var munged_ns = cljs.core.nth.call(null,vec__39816,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39816,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39816,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39816,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39816,(4),null);
var arity = cljs.core.nth.call(null,vec__39816,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__39820 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__39820,(0),null);
var args = cljs.core.nth.call(null,vec__39820,(1),null);
var vec__39823 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39823,(0),null);
var name = cljs.core.nth.call(null,vec__39823,(1),null);
...
var G__39826 = (arity + (1));
var G__39827 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39828){
var vec__39829 = p__39828;
var arity = cljs.core.nth.call(null,vec__39829,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39829,(1),null);
...
return cljs.core.get.call(null,arities,p1__39832_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39833_SHARP_);
...
var args__28371__auto__ = [];
var len__28364__auto___39840 = arguments.length;
var i__28365__auto___39841 = (0);
while(true){
if((i__28365__auto___39841 < len__28364__auto___39840)){
args__28371__auto__.push((arguments[i__28365__auto___39841]));

var G__39842 = (i__28365__auto___39841 + (1));
i__28365__auto___39841 = G__39842;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39836){
var vec__39837 = p__39836;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39837,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39834){
var G__39835 = cljs.core.first.call(null,seq39834);
var seq39834__$1 = cljs.core.next.call(null,seq39834);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__39835,seq39834__$1);
});
...
var G__39843 = arg;
var G__39843__$1 = (((G__39843 instanceof cljs.core.Keyword))?G__39843.fqn:null);
switch (G__39843__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39845__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39845__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39845__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39845__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39846 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39846,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39846,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39846,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39846,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39846,(4),null);
var arity = cljs.core.nth.call(null,vec__39846,(5),null);
...
}catch (e39850){var _e__38917__auto__ = e39850;
...
var G__39851 = (obj[cljs.core.first.call(null,path)]);
var G__39852 = cljs.core.rest.call(null,path);
obj = G__39851;
path = G__39852;
continue;
} else {
...
return (function (accum,p__39853){
var vec__39854 = p__39853;
var bit = cljs.core.nth.call(null,vec__39854,(0),null);
var protocol = cljs.core.nth.call(null,vec__39854,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39857){
var vec__39858 = p__39857;
var ns = cljs.core.nth.call(null,vec__39858,(0),null);
var name = cljs.core.nth.call(null,vec__39858,(1),null);
var selector = cljs.core.nth.call(null,vec__39858,(2),null);
...
return (function (p__39862){
var vec__39863 = p__39862;
var munged_name = cljs.core.nth.call(null,vec__39863,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39863,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39863,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39861_SHARP_){
return (obj[cljs.core.first.call(null,p1__39861_SHARP_)]);
});})(name,sorted_matches,vec__39863,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1513846758072
